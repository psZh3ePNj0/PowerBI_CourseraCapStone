...
The Goal in this section is to turn $$\color{blue}data \space into \space insights$$. Here we’ll use $$\color{blue}DAX$$ to calculate annual and quarterly profits and analyze data sets to create a clear financial story through:

- Creating time-based summaries for displaying quarterly, annual, and year-to-date profit data.
